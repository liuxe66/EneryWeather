...
public class SpUtils {
    ...
    public static String CUR_POSITION = "CUR_POSITION";//当前选中的集合
    public static String CUR_CITY_ID = "CUR_CITY_ID";//定位的城市
    public static String ADD_CITY_ID = "ADD_CITY_ID";//添加的城市
